...
<body>
    <div class="container">
        ...
        <h1 class="mt-5 mb-5">
            Manage Users
            <span class="badage bg-danger text-white">
                <?= count($all) ?>
            </span>
        </h1>
                        ...
                        <?php if($auth->value >1) :?>
                            <div class="btn-group dropdown">
                                ...
                                <?php if($user->id !==$auth->id) :?>
                                    <a href="./_actions/delete.php?id<?=$user->id?>" class="btn btn-sm btn-outline-danger" onClick="return confirm('Are You Sure to Delete')">Delete</a>
                                <?php endif ?>
                            </div>
                        <?php else: ?>
                            ###
